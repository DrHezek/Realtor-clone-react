          ...
          <form>
            ...
            <div className="flex mb-6 justify-between whitespace-nowrap text-sm sm:text-lg">
              <p className="flex items-center">
                ...
                <span className="text-red-600 hover:text-red-700 transition ease-in-out-200 ml-1 cursor-pointer">
                  Edit
                </span>{" "}
              </p>
              <p
                onClick={onLogOut}
                className="text-blue-600 hover:text-blue-800 transition ease-in-out-200 cursor-pointer  "
              >
                Sign Out
              </p>
            </div>
